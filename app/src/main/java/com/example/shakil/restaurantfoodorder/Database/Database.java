package com.example.shakil.restaurantfoodorder.Database;
...
public class Database extends SQLiteAssetHelper {
    ...
    public void removeFromCart(String productId, String phone) {
        SQLiteDatabase db = getReadableDatabase();
        String query = String.format("DELETE FROM OrderDetail WHERE ProductId='%s' AND UserPhone='%s'",productId, phone);
        db.execSQL(query);
    }
